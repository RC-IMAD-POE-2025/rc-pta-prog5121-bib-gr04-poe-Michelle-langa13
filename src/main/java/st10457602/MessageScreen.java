...
public class MessageScreen {
    ...
    private void processMessageBatch() {
        ...
        JOptionPane.showMessageDialog(null, "Batch processing complete. Total messages successfully sent in this session: " + MessageFeature.returnTotalMessages(), "Batch Summary", JOptionPane.INFORMATION_MESSAGE);
    }
}
